...
namespace DigiCV.Web.Data.Migrations
{
    ...
    [Migration("20230923141826_AddResumeTemplate")]
    partial class AddResumeTemplate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DigiCV.Persistence.Features.Membership.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3e6c03b7-bbdc-407c-96f8-03ce604dd5e7",
                            Email = "admin@digicv.com",
                            EmailConfirmed = true,
                            FullName = "Admin",
                            JoiningDate = new DateTime(2023, 9, 23, 20, 18, 25, 962, DateTimeKind.Local).AddTicks(2249),
                            LockoutEnabled = true,
                            NormalizedEmail = "ADMIN@DIGICV.COM",
                            NormalizedUserName = "ADMIN@DIGICV.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEMtPn0JicGBWy7WZQqo4Eq4eBTUN4t6bOqlKrh1FP43ZIP7cULgo7z8l6FJswENEMQ==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ef23bd84-c692-4030-83b8-7d2f1fe9f6fb",
                            Email = "manager@digicv.com",
                            EmailConfirmed = true,
                            FullName = "Manager",
                            JoiningDate = new DateTime(2023, 9, 23, 20, 18, 26, 97, DateTimeKind.Local).AddTicks(8938),
                            LockoutEnabled = true,
                            NormalizedEmail = "MANAGER@DIGICV.COM",
                            NormalizedUserName = "MANAGER@DIGICV.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEJ8XgGO7ArVXWwQD/q9SEIL93kinfqHIbeXQdqnPXVetvu0h5ajWsdIbHGGsH7E0PQ==",
                            PhoneNumber = "+8801856817465",
                            PhoneNumberConfirmed = false,
